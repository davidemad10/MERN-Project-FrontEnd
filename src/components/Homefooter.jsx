                ...
                <footer className="py-5 ">
                    <div className="row">
                        ...
                        <div className="col-6 col-md-2 mb-3">
                            <h5>WORK WITH US</h5>
                            <ul className="nav flex-column">
                                <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Authors</a></li>
                                <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Advertise</a></li>
                                <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Authors & ads blog</a></li>
                        ...
                        <div className="col-6 col-md-2 mb-3">
                            ...
                            <ul className="nav flex-row pt-1">
                                <li className="nav-item mb-2 mx-1"><a href="#" className="nav-link p-0 text-muted"><i class="fa-brands fa-xl fa-facebook"></i></a></li>
                                <li className="nav-item mb-2 mx-1"><a href="#" className="nav-link p-0 text-muted"><i class="fa-brands fa-xl fa-twitter"></i></a></li>
                                <li className="nav-item mb-2 mx-1"><a href="#" className="nav-link p-0 text-muted"><i class="fa-brands fa-xl fa-instagram"></i></a></li>
                                <li className="nav-item mb-2 mx-1"><a href="#" className="nav-link p-0 text-muted"><i class="fa-brands fa-xl fa-linkedin"></i></a></li>
                            </ul>
                        </div>
